(function () {
  const dict = {
    tr: {
      ...
      faq7_a: "Bu sitede tek kasa var: Lemon Squeezy. Kart bilgisi bize gelmez. Microsoft Store ayrı bir vitrin olabilir; oradan aldıysanız iade ve güncelleme Store kurallarına bakar.",
      faq8_q: "Beğenmezsem ne olur?",
      faq8_a: "Bu siteden aldıysanız 14 gün içinde, lisansı kötüye kullanmadıysanız hello@younews.media yazın. Lemon Squeezy kendi kesintisini tutabilir. Store’dan aldıysanız Microsoft’un iade yolu geçerlidir.",
      faq9_q: "Kurulum dosyası hemen iner mi?",
      faq9_a: "Lemon Squeezy başvurumuz incelemede olabilir. Onay ve dosya bağlanınca indirme ödeme sonrası gelir. Takılırsanız aynı adrese yazın.",
      price_note: "bir kez · Windows",
      checkout: "Kartı Lemon Squeezy alır. Bu sitede ikinci bir ödeme butonu yok.",
      ...
      disc_3: "Uygulamayı Microsoft Store dışından aldıysanız güncelleme ve iade Microsoft’un işi değildir. Bu site ve Lemon Squeezy satıcıdır.",
      back: "← Ana sayfa",
      ...
      priv_4: "Bu site vitrindir. Ödemeyi Lemon Squeezy işler; kart numarası burada durmaz. Ödeme gizliliği onların metnidir.",
      contact: "Yazın:",
      title_refund: "İade — You News",
      ref_h: "İade ve güncelleme",
      ref_1: "Buradan (Lemon Squeezy) alınan kopyada iade ve güncelleme satıcının işidir, Microsoft’un değil.",
      ref_2: "Satın alımdan sonra 14 gün içinde, lisansı paylaşmadıysanız veya kırmadıysanız hello@younews.media yazın. Ödeme firması kendi kesintisini uygulayabilir.",
    ...
    en: {
      ...
      faq7_a: "Only Lemon Squeezy on this site. We never see your card. Microsoft Store may be a separate shop; if you bought there, their refund and update rules apply.",
      faq8_q: "What if it isn’t for me?",
      faq8_a: "Bought here? Email hello@younews.media within 14 days, so long as the license wasn’t abused. Lemon Squeezy may keep its own fees. Bought in the Store? That’s Microsoft’s refund path.",
      faq9_q: "Do I get the installer right away?",
      faq9_a: "Lemon Squeezy may still be reviewing us. Once we’re approved and the file is attached, it comes after payment. If you’re stuck, write to the same address.",
      price_note: "once · Windows",
      checkout: "Lemon Squeezy handles the card. There is no second pay button on this site.",
      ...
      disc_3: "If you bought outside the Microsoft Store, updates and refunds are on us (this site / Lemon Squeezy), not on Microsoft.",
      back: "← Home",
      ...
      priv_4: "This website is the brochure. Lemon Squeezy takes payment; card numbers don’t live here. Their privacy policy covers checkout.",
      contact: "Write to us:",
      title_refund: "Refunds — You News",
      ref_h: "Refunds and updates",
      ref_1: "If you bought here (Lemon Squeezy), refunds and updates are the seller’s job, not Microsoft’s.",
      ref_2: "Within 14 days, if you didn’t share or crack the license, email hello@younews.media. The payment firm may keep its cut.",
